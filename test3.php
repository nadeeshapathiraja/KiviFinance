        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" readonly class="form-control-plaintext" id="totalIncome" name="totalIncome"
                            value="10000">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Loan_creditcard_expence" name="income_amount">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Asset Type</label>
                                                <input type="text" class="form-control" id="liabilities_asset_type[]"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Money Owing</label>
                                                <input type="text" class="form-control" id="liabilities_money_owing[]"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input class="form-check-input" type="radio"
                                                            ...
                                                            id="liabilities_frequency_Radio[]" value="Weekly" checked>
                                                        <label class="form-check-label">
                                                            Weekly
                                                        </label>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <input class="form-check-input" type="radio"
                                                            name="liabilities_frequency_Radio[]"
                                                            id="liabilities_frequency_Radio[]" value="Monthly" checked>
                                                        <label class="form-check-label">
                                                            Monthly
                                                        </label>
                                                    </div>
